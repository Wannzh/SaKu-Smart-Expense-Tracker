...
const RegisterPage = memo(function RegisterPage() {
  ...
  }, [form.name, form.email, form.password, agreedToTerms]);
  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    try {
      ...
      // New normal register always navigates to onboarding
      navigate("/onboarding");
    } catch (err) {
  ...
  }, [form.name, form.email, form.password, validate, register, navigate]);
            ...
            <div className="flex flex-col w-full mt-1">
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  className="mt-0.5 h-4.5 w-4.5 rounded border-gray-300 dark:border-slate-700 text-indigo-600 focus:ring-indigo-500"
                />
